...
var ReactDelayRender = exports.ReactDelayRender = function (_Component) {
  ...
  function ReactDelayRender() {
    ...
    var _this = _possibleConstructorReturn(this, (ReactDelayRender.__proto__ || Object.getPrototypeOf(ReactDelayRender)).call(this));
...
ReactDelayRender.propTypes = {
  ...
  onFinishRender: _propTypes2.default.func
};
